...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?php echo get_theme_file_uri('assets/css/templatemo-edu-meeting.css');?>">
...
<body>
  ...
  <section class="contact-us" id="contact">
    ...
    <div class="footer">
      <p>Copyright © 2022 Edu Meeting Co., Ltd. All Rights Reserved. 
          <br>Design: <a href="#" target="_parent" title="free css templates">NEHAD</a></p>
    </div>
  </section>
  ...
  <!-- Bootstrap core JavaScript -->
    ...
    <script src="<?php echo get_theme_file_uri('assets/js/lightbox.js')?>"></script>
    <script src="<?php echo get_theme_file_uri('assets/js/tabs.js')?>"></script>
    <script src="<?php echo get_theme_file_uri('assets/js/video.js')?>"></script>
    <script src="<?php echo get_theme_file_uri('assets/js/slick-slider.js')?>"></script>
